...
export function Panel({
  ...
  return (
    <div className={clsx('bg-slate-800/50 rounded-lg border border-slate-700 flex flex-col', className)}>
      ...
      <div className={clsx('flex-1', scroll && 'overflow-y-auto', contentClassName)}>{children}</div>
    </div>
  );
}
